...
import { Zap, Mail, Lock, Eye, EyeOff, ArrowRight, Github, User, Building2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#05050a] text-white font-sans flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-5 py-12 sm:px-8 lg:px-12">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="font-syne text-2xl md:text-3xl font-extrabold text-white mb-2">Create your account</h1>
            <p className="text-sm text-white/50">Start managing your business today</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              <User className={`w-5 h-5 mb-2 ${accountType === "individual" ? "text-indigo-400" : "text-white/40"}`} />
              <p className="font-medium text-sm text-white">Individual</p>
              <p className="text-xs text-white/40 mt-0.5">For freelancers</p>
            </button>
            <button
              type="button"
            ...
            >
              <Building2 className={`w-5 h-5 mb-2 ${accountType === "business" ? "text-indigo-400" : "text-white/40"}`} />
              <p className="font-medium text-sm text-white">Business</p>
              <p className="text-xs text-white/40 mt-0.5">For companies</p>
            </button>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full h-12 rounded-xl bg-white/5 border border-white/10 text-white font-medium flex items-center justify-center gap-3 hover:bg-white/10 hover:border-white/20 transition-all"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" required className="mt-1 w-4 h-4 rounded bg-white/5 border-white/20 text-indigo-500 focus:ring-indigo-500/20" />
              <span className="text-sm text-white/50">
                I agree to the{" "}
                <Link href="/terms" className="text-indigo-400 hover:text-indigo-300 no-underline">Terms of Service</Link>
                {" "}and{" "}
                <Link href="/privacy" className="text-indigo-400 hover:text-indigo-300 no-underline">Privacy Policy</Link>
              </span>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-white/50">
            ...
            <Link href="/auth/login" className="text-indigo-400 hover:text-indigo-300 font-medium no-underline">
              Sign in
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
          ...
          <h2 className="font-syne text-2xl font-extrabold text-white mb-2">Join BizSnapPro</h2>
          <p className="text-white/50 max-w-sm">Start your free account and manage your business like a pro.</p>
        </div>
      </div>
    </div>
  );
